 ...
 * 
 */
public class WebNodeCoreAction {

	private static WebNodeCoreAction singleton;

	private final String jsonPath;

	private ZkController zkController;

	private Map<String,String> liveNodes;
	...
	private static Logger _log = LoggerFactory.getLogger(WebNodeCoreAction.class);
	...
	private WebNodeCoreAction(String jsonPath) {
		this.jsonPath = jsonPath;

		init();
	}

	public static synchronized WebNodeCoreAction getInstance(String jsonPath) {
		if (singleton == null) {
			singleton = new WebNodeCoreAction(jsonPath);
		}
		return singleton;
	...
	public static void main(String[] args) {
		 ...
		 WebNodeCoreAction.getInstance("D:\\workspaceN\\ce-zkcli\\src\\main\\resources\\zkinit.json");
