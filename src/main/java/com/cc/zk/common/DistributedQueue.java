...
import com.cc.zk.common.CeException.ErrorCode;
...
public class DistributedQueue {
  ...
  public DistributedQueue(ZkClient zookeeper, String dir, List<ACL> acl) {
    this.dir = dir;
    ...
    try {
      ...
      throw new CeException(ErrorCode.SERVER_ERROR, e);
