...
public class ZkClient {
  ...
  public ZkClient(String zkServerAddress, int zkClientTimeout, int zkClientConnectTimeout, OnReconnect onReonnect) {
  ...
  private void closeKeeper(CeZooKeeper keeper) {
    if (keeper != null) {
      try {
        ...
        log.error("", e);
        throw new ZooKeeperException(CeException.ErrorCode.SERVER_ERROR, "",
            e);
      }
    }
  }
