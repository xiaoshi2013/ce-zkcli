...
public class ZkCmdExecutor {
  ...
  public void ensureExists(String path, final ZkClient zkClient) throws KeeperException, InterruptedException {
    ensureExists(path, null, CreateMode.PERSISTENT, zkClient);
  }
  
  public void ensureExists(final String path, final byte[] data,
      CreateMode createMode, final ZkClient zkClient) throws KeeperException, InterruptedException {
