...
public class Iostat extends SigarCommandBase {
    ...
    public void printHeader() {
    	  System.out.println("Iostat.outputFileSystem() 11111");
        printf(HEADER);
    }

    private String svctm(double val) {
    	 System.out.println("Iostat.outputFileSystem() 66666");
    	 
        return sprintf("%3.2f", new Object[] { new Double(val) });
    }

    public void output(String[] args) throws SigarException {
    	 System.out.println("Iostat.outputFileSystem() 22222");
        if (args.length == 1) {
            String arg = args[0];
            ...
            for (FileSystem fileSystem : fslist) {
      		 System.out.println( fileSystem.getDevName());
  		}
    ...
    public void outputFileSystem(String arg) throws SigarException {
    	 System.out.println("Iostat.outputFileSystem() 555555");
    ...
    public void outputDisk(String name) throws SigarException {
    	 System.out.println("Iostat.outputFileSystem() 333333");
        DiskUsage disk =
    ...
    public void output(FileSystem fs) throws SigarException {
    	 System.out.println("Iostat.outputFileSystem() 44444");
